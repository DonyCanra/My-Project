...
class AdminController {
  ...
  static async createItem(req, res, next) {
    try {
      ...
      const { name, description, price, imgUrl, UserId, CategoryId, ingredients, UserMongoId } = req.body;
      ...
      const ingredientsData = answ.map((name) => {
        return {
          ItemId: item.id,
          name: name,
        };
      ...
      const data = await Ingredient.bulkCreate(ingredientsData);
